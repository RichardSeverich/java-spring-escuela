...
*/
@Service
public class ServiceJoinCourseStudentSubject implements IService {
  ...
  */
  ...
  public Response getResponse() {
    Iterable<StudentSubjectJoin> iterable =
        repository.findCourseStudentSubjectJoin(helper.getId());
